...
export function AuthorityNumbers() {
  return (
    <section
      ...
      className="border-b border-[#dbe4ef] bg-[#f5f7fa] py-8 text-[#001a4d] sm:py-10"
    >
      <Container>
        <div className="grid grid-cols-2 gap-x-5 gap-y-8 lg:grid-cols-4 lg:divide-x lg:divide-[#d8e1ec]">
          {stats.map((stat) => (
            <div key={stat.label} className="lg:px-8 lg:first:pl-0 lg:last:pr-0">
              ...
              <p className="mt-2 text-sm font-semibold leading-5 text-[#61728a]">
                {stat.label}
              </p>
            </div>
          ))}
