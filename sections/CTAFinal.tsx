...
export function CTAFinal() {
  return (
    <section className="bg-[#f5f7fa] pb-16 sm:pb-20 lg:pb-24">
      <Container>
        <div className="relative overflow-hidden rounded-[30px] bg-solar-green p-7 text-navy sm:p-10 lg:p-14">
          <div
            aria-hidden
            className="absolute -right-20 -top-24 h-72 w-72 rounded-full border-[48px] border-[#001a4d]/[0.07]"
          />
          <div className="relative grid items-end gap-8 lg:grid-cols-[1fr_auto]">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-base font-medium leading-7 text-[#244d61] sm:text-lg">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex min-h-14 items-center justify-center gap-3 rounded-full bg-navy px-6 py-4 text-sm font-black text-white transition hover:-translate-y-0.5 hover:bg-[#00439a] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-navy"
            >
