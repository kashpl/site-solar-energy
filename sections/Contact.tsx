  ...
  return (
    <section id="contato" className="bg-[#020812] py-20 text-white sm:py-24 lg:py-28">
      <Container>
        ...
        <div data-reveal className="mt-14 grid overflow-hidden rounded-[26px] border border-white/18 bg-[#001a4d] shadow-[0_30px_90px_rgba(0,0,0,.34)] lg:grid-cols-[0.68fr_1.32fr] lg:mt-16">
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            <form onSubmit={handleSubmit} className="grid gap-5" noValidate>
              ...
              <div aria-live="polite">{status === "success" ? <p className="rounded-xl border border-solar-green/35 bg-solar-green/10 p-4 text-sm text-solar-green">Solicitação enviada. Nossa equipe entrará em contato em breve.</p> : null}{status === "error" ? <p className="rounded-xl border border-[#ffb4b4]/40 bg-[#ffb4b4]/10 p-4 text-sm text-[#ffb4b4]">Não foi possível enviar. Tente novamente ou fale pelo WhatsApp.</p> : null}</div>
            </form>
          </div>
        </div>
      </Container>
